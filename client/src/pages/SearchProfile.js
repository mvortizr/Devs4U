...
export default function Dashboard(props) {
  ...
  React.useEffect(() => {
      ...
      axios({ method: 'post',
          ...
          data: { page:devPage , pageSize: devPageSize, query:query.name }
        })
        .then(response =>{
        ...
        <main className={classes.content}>
          ...
          <Container className={classes.cardGrid} maxWidth="md">
            ...
            <Typography gutterBottom variant="h5" component="h2" className={classes.searchResult}>
                  Se ha{devTotalCount>1?('n'):('')} encontrado {devTotalCount} resultado{devTotalCount>1?('s'):('')}
            </Typography>):
            (<Typography gutterBottom variant="h5" component="h2" className={classes.searchResult}>
                      ...
                      <div className={classes.details}>
                        <CardContent className={classes.cardContent}>
                          <Typography gutterBottom variant="h5" component="h2">
                           ...
                           <Typography>
                            Rol: {card.rol=== 'contractor'?('Contratista'):('Freelancer')}              
                          </Typography>                
